    ...
    <div class="offset-sm-2 col-sm-8">
        <div class="card">
            <div class="card-header">
                <strong>Contact Provider Form</strong>
            </div>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="name" v-model="name" name="name" placeholder="Enter provider name" class="form-control">
            ...
            <div class="card-footer">
                <button type="submit" v-on:click="createOrUpdateContactProvider()" class="btn btn-primary btn-sm">
...
export default {
    ...
    methods: {
        createOrUpdateContactProvider() {
            var data = {}
            data['name'] = this.name
            data['description'] = this.description
            
            if(this.id == ''){
                ContactProviderAPI.createContactProvider(data)
                .then(response => {
                    this.id = response.id
                ...
                ContactProviderAPI.updateContactProvider(data, this.id)
                .then(response => {
                    this.tmp = response
        ...
        getContactProviderInformation(id) {
            ContactProviderAPI.getContactProvider(id)
            .then(response => {
                this.id = response.id
    ...
    mounted() {
        ...
        if (urlPath[urlPath.length - 1] == 'edit'){
            this.getContactProviderInformation(urlPath[urlPath.length - 2])
        }
    },
}
</script>
